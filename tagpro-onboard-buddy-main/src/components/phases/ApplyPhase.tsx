...
export const ApplyPhase: React.FC<ApplyPhaseProps> = ({ onNext, onBack }) => {
  return (
    <PhaseContainer
      ...
      subtitle="Apply your Tag Pro device"
    >
      <div className="space-y-6">
        <div className="text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground mb-6">
            Peel off adhesive backing and place Tag Pro on the cleaned spot with correct orientation.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <img 
            src={tagProPhoto} 
            alt="Tag Pro correct placement example"
